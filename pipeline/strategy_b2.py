...
STATE_FILE  = '/root/gold-signals/pipeline/state_b2.json'
PROCESSED_FILE = '/root/gold-signals/pipeline/processed_b2.json'
TRADES_FILE = '/root/gold-signals/pipeline/trades_b2.json'
